...
<div class="row">
    ...
    <br><br>
        ...
        <fieldset>
            ...
            <input value="<?php echo $TitleDelete; ?>" class="form-control" type="text" name="Title" id="title" placeholder="Title">
            </div>
            <div class="form-group">
            <label for="categoryselect"><span class="FieldInfo">Category:</span></label>
            <span class="FieldInfo">Existing Category:</span>
            <?php echo $CategoryDelete; ?>
...
<?php } ?>
            ...
            <img src="upload/<?php echo $ImageDelete; ?>"width=170; height=70px;>
